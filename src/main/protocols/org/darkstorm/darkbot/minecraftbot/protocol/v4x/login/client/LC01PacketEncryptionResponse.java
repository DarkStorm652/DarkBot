...
public class LC01PacketEncryptionResponse extends AbstractPacketX implements WriteablePacket {
	private final SecretKey secretKey;
	private final PublicKey publicKey;
	private final byte[] sharedSecret, verifyToken;

	public LC01PacketEncryptionResponse(SecretKey secretKey, PublicKey publicKey, byte[] verifyToken) {
