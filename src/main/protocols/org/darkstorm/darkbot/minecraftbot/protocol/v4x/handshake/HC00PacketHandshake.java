...
public class HC00PacketHandshake extends AbstractPacketX implements WriteablePacket {
	private final int protocolVersion;
	private final String address;
	private final int port;
	private final State nextState;

	public HC00PacketHandshake(int protocolVersion, String address, int port, State nextState) {
