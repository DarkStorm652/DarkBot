...
public class C0BPacketEntityAction extends AbstractPacketX implements WriteablePacket {
	private int entityId, jumpBoost;
	private Action action;

	public C0BPacketEntityAction(int entityId, Action action, int jumpBoost) {
