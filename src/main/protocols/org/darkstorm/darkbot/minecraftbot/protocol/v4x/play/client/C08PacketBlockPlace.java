...
public class C08PacketBlockPlace extends AbstractPacketX implements WriteablePacket {
	private int x, y, z, direction;
	private float offsetX, offsetY, offsetZ;
	private ItemStack item;

	public C08PacketBlockPlace(int x, int y, int z, int direction, ItemStack item, float offsetX, float offsetY, float offsetZ) {
