package org.darkstorm.minecraft.darkbot.protocol.v5x;
...
import org.darkstorm.minecraft.darkbot.event.protocol.server.PlayerEquipmentUpdateEvent.EquipmentSlot;
import org.darkstorm.minecraft.darkbot.event.protocol.server.RotatedEntitySpawnEvent.RotatedSpawnLocation;
import org.darkstorm.minecraft.darkbot.protocol.*;
import org.darkstorm.minecraft.darkbot.protocol.v5x.handshake.PacketHC00_Handshake;
import org.darkstorm.minecraft.darkbot.protocol.v5x.login.client.*;
import org.darkstorm.minecraft.darkbot.protocol.v5x.login.server.*;
import org.darkstorm.minecraft.darkbot.protocol.v5x.play.client.*;
import org.darkstorm.minecraft.darkbot.protocol.v5x.play.client.PacketC15_ClientSettings.*;
import org.darkstorm.minecraft.darkbot.protocol.v5x.play.server.*;
import org.darkstorm.minecraft.darkbot.protocol.v5x.play.server.PacketS0B_Animation.Animation;
import org.darkstorm.minecraft.darkbot.protocol.v5x.play.server.PacketS21_ChunkData.ChunkData;
...
public final class Protocol5X extends AbstractProtocolX implements EventListener {
	public final class LengthPacket extends AbstractPacketX implements ReadablePacket {
		...
		protected LengthPacket(int id, int length) {
			super(id, org.darkstorm.minecraft.darkbot.protocol.v5x.Protocol5X.this.getState(), Direction.DOWNSTREAM);
    ...
    public static final class Provider extends ProtocolProvider<Protocol5X, PacketLengthHeader> {
        @Override
	...
	public void onPacketReceived(PacketReceivedEvent event) {
		...
		if(packet instanceof PacketLS01_EncryptionRequest) {
			...
			if(!transactionPacket.isAccepted())
				handler.sendPacket(new PacketC0F_ConfirmTransaction(transactionPacket.getWindowId(), transactionPacket.getActionId(), false));
		}
	}
