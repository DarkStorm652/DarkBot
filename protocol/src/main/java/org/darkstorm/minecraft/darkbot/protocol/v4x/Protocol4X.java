package org.darkstorm.minecraft.darkbot.protocol.v4x;
...
import org.darkstorm.minecraft.darkbot.protocol.v4x.handshake.PacketHC00_Handshake;
import org.darkstorm.minecraft.darkbot.protocol.v4x.login.client.*;
import org.darkstorm.minecraft.darkbot.protocol.v4x.login.server.*;
import org.darkstorm.minecraft.darkbot.protocol.v4x.play.client.*;
import org.darkstorm.minecraft.darkbot.protocol.v4x.play.client.PacketC15_ClientSettings.*;
import org.darkstorm.minecraft.darkbot.protocol.v4x.play.server.*;
import org.darkstorm.minecraft.darkbot.protocol.v4x.play.server.PacketS0B_Animation.Animation;
...
public final class Protocol4X extends AbstractProtocolX implements EventListener {
	public final class LengthPacket extends AbstractPacketX implements ReadablePacket {
		...
		protected LengthPacket(int id, int length) {
			super(id, org.darkstorm.minecraft.darkbot.protocol.v4x.Protocol4X.this.getState(), Direction.DOWNSTREAM);
    ...
    public static final class Provider extends ProtocolProvider<Protocol4X, PacketLengthHeader> {
        @Override
